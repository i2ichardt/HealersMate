...
local function CreatePlayerBuffDebuffIcon(texturePath, StackSize, xOffset,Btype)
...
-- Function to create and set a texture for a buff or debuff icon
local function CreateParty1BuffDebuffIcon(texturePath, StackSize, xOffset,Btype)
    -- Create a frame; must be a frame so i can create the mouseover tooltip for the buff
...
-- Function to create and set a texture for a buff or debuff icon
local function CreateParty2BuffDebuffIcon(texturePath, StackSize, xOffset,Btype)
    -- Create a frame; must be a frame so i can create the mouseover tooltip for the buff
...
-- Function to create and set a texture for a buff or debuff icon
local function CreateParty3BuffDebuffIcon(texturePath, StackSize, xOffset,Btype)
    -- Create a frame; must be a frame so i can create the mouseover tooltip for the buff
...
-- Function to create and set a texture for a buff or debuff icon
local function CreateParty4BuffDebuffIcon(texturePath, StackSize, xOffset,Btype)
    -- Create a frame; must be a frame so i can create the mouseover tooltip for the buff
...
local function UpdatePlayerBuffDebuffIcons()
    ...
    for i = 1, 40 do
		...
		if not IconTexturePath then break end
			...
			CreatePlayerBuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Buff")
			xOffset = xOffset + 20
    ...
    while true do
		...
		if not IconTexturePath then break end
        CreatePlayerBuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Debuff")
        xOffset = xOffset + 20
		i = i + 1
    end
...
local function UpdateParty1BuffDebuffIcons()
    ...
    for i = 1, 40 do
		...
		if not IconTexturePath then break end
			...
			CreateParty1BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Buff")
			xOffset = xOffset + 20
    ...
    while true do
		...
		if not IconTexturePath then break end
        CreateParty1BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Debuff")
        xOffset = xOffset + 20
		i = i + 1
    end
...
local function UpdateParty2BuffDebuffIcons()
    ...
    for i = 1, 40 do
		...
		if not IconTexturePath then break end
			...
			CreateParty2BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Buff")
			xOffset = xOffset + 20
    ...
    while true do
		...
		if not IconTexturePath then break end
        CreateParty2BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Debuff")
        xOffset = xOffset + 20
		i = i + 1
    end
...
local function UpdateParty3BuffDebuffIcons()
    ...
    for i = 1, 40 do
		...
		if not IconTexturePath then break end
			...
			CreateParty3BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Buff")
			xOffset = xOffset + 20
    ...
    while true do
		...
		if not IconTexturePath then break end
        CreateParty3BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Debuff")
        xOffset = xOffset + 20
		i = i + 1
    end
...
local function UpdateParty4BuffDebuffIcons()
    ...
    for i = 1, 40 do
		...
		if not IconTexturePath then break end
			...
			CreateParty4BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Buff")
			xOffset = xOffset + 20
    ...
    while true do
		...
		if not IconTexturePath then break end
        CreateParty4BuffDebuffIcon(IconTexturePath, StackSize, xOffset, "Debuff")
        xOffset = xOffset + 20
		i = i + 1
    end
